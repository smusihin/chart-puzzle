...
const specTarget = {
  ...
  drop(props, monitor, component) {
    ...
    const item = monitor.getItem();
    component.addItem(item.elemType);
...
Board.propTypes = {classes: PropTypes.object.isRequired};

export default withStyles(styles)(DropTarget(Types.CARD, specTarget, collect)(Board));